...
export function TournamentCreatorComponent() {
      ...
      <CardContent>
        <form className="space-y-4">
          <div>
            ...
            <Input id="tournamentName" placeholder="Nome do Torneio" />
          </div>
          ...
          <hr />
          <h3 className="text-lg font-semibold mb-2">Local em que acontecerá o torneio</h3>
          <div>
          ...
          <div>
            ...
            <RadioGroup defaultValue="groups">
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="groups">Fase de grupos com 4x4 de grupos + Eliminação simples (Sorteio de duplas)</Label>
              </div>
              {/* <div className="flex items-center space-x-2">
          ...
          <div>
            ...
            <Button variant="outline" type="button" size="sm" className="mt-2">+ Adicionar categoria</Button>
          </div>
          ...
          <div>
            ...
            {participants.map((participant, index) => (
              <div key={index} className="flex items-center space-x-2 mb-2">
                ...
                />
                <Button variant="destructive" type="button" size="sm" onClick={() => removeParticipant(index)}>Excluir</Button>
              </div>
            ))}
            <Button variant="outline" type="button" size="sm" onClick={addParticipant}>Adicionar participante</Button>
          </div>
